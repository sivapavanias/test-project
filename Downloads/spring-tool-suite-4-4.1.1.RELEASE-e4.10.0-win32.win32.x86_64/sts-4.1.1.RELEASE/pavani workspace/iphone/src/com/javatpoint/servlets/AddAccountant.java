...
import com.javatp.beans.AccountantBean;
import com.javatp.beans.StudentBean;
...
public class AddAccountant extends HttpServlet {
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<html>");
		out.println("<head>");
		out.println("<title>Customer Added</title>");
		...
		out.print("<h1>Add Customer Form</h1>");
		out.println("<p>Customer is added successfully!</p>");
